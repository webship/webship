...
/**
 * Tests Webship installation profile expectations.
 *
 * @group webship
 */
class WebshipTest extends BrowserTestBase {

  use SchemaCheckTestTrait;

  protected $profile = 'webship';
  ...
  /**
   * Tests Webship installation profile.
   */
  public function testWebship() {
    $this->drupalGet('');
    ...
    // Configure the block.
    $this->drupalGet('admin/structure/block/add/system_menu_block:main/webtheme');
    ...
    // Webship profile modules are enabled.
    ...
    // Ensure that configuration from the Webship profile is not reused when
    ...
    // Make sure the optional image styles are installed.
