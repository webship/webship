...
namespace Drupal\Tests\webship\FunctionalJavascript;

use Drupal\FunctionalJavascriptTests\WebDriverTestBase;
use Drupal\node\Entity\Node;

/**
 * Tests Webship installation profile JavaScript expectations.
 *
 * @group standard
 */
class WebshipJavascriptTest extends WebDriverTestBase {
  ...
  /**
   * Tests BigPipe accelerates particular Webship installation profile routes.
   */
