...
namespace Drupal\webship\entity;
...
/**
 * Webship Entity Definition Update Manager.
 *
 * Customized class from the Devel Entity Updates module
 * Development version of the entity definition update manager.
 */
final class WebshipEntityDefinitionUpdateManager implements ContainerInjectionInterface {
